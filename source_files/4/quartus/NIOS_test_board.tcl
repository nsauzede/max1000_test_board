...
# #TE_MOD# set_project_property DEVICE {10M16SAU169C8G} 
# #TE_MOD#_Add next line 
...
set_instance_parameter_value pll {CLK0_DIVIDE_BY} {750003}
set_instance_parameter_value pll {CLK0_DUTY_CYCLE} {50}
set_instance_parameter_value pll {CLK0_MULTIPLY_BY} {6250000}
set_instance_parameter_value pll {CLK0_PHASE_SHIFT} {0}
set_instance_parameter_value pll {CLK1_DIVIDE_BY} {6}
set_instance_parameter_value pll {CLK1_DUTY_CYCLE} {50}
set_instance_parameter_value pll {CLK1_MULTIPLY_BY} {25}
set_instance_parameter_value pll {CLK1_PHASE_SHIFT} {-5000}
...
# #TE_MOD# set_instance_parameter_value sdram_controller {SDRAM_COL_W} {9} 
# #TE_MOD# set_instance_parameter_value sdram_controller {SDRAM_MHZ} {100} 
# #TE_MOD# set_instance_parameter_value sdram_controller {SDRAM_ROW_W} {13} 
...
add_interface pio_mode conduit end
set_interface_property pio_mode EXPORT_OF pio_sel.external_connection
...
set_connection_parameter_value niosv_m.data_manager/flash.avl_csr baseAddress {0x04800000}
...
set_connection_parameter_value niosv_m.data_manager/flash.avl_mem baseAddress {0x04000000}
...
set_connection_parameter_value niosv_m.data_manager/niosv_m.timer_sw_agent baseAddress {0x04800180}
...
set_connection_parameter_value niosv_m.data_manager/pio_led.s1 baseAddress {0x04800140}
...
set_connection_parameter_value niosv_m.data_manager/pio_sel.s1 baseAddress {0x04800150}
...
set_connection_parameter_value niosv_m.data_manager/pll.pll_slave baseAddress {0x04800160}
...
set_connection_parameter_value niosv_m.data_manager/sdram_controller.s1 baseAddress {0x0000}
...
set_connection_parameter_value niosv_m.data_manager/spi_g_sensor.spi_control_port baseAddress {0x04800100}
...
set_connection_parameter_value niosv_m.data_manager/uart.s1 baseAddress {0x04800120}
...
set_connection_parameter_value niosv_m.instruction_manager/flash.avl_csr baseAddress {0x04800000}
...
set_connection_parameter_value niosv_m.instruction_manager/flash.avl_mem baseAddress {0x04000000}
...
set_connection_parameter_value niosv_m.instruction_manager/pio_led.s1 baseAddress {0x04800140}
...
set_connection_parameter_value niosv_m.instruction_manager/pio_sel.s1 baseAddress {0x04800150}
...
set_connection_parameter_value niosv_m.instruction_manager/pll.pll_slave baseAddress {0x04800160}
...
set_connection_parameter_value niosv_m.instruction_manager/sdram_controller.s1 baseAddress {0x0000}
...
set_connection_parameter_value niosv_m.instruction_manager/spi_g_sensor.spi_control_port baseAddress {0x04800100}
...
set_connection_parameter_value niosv_m.instruction_manager/uart.s1 baseAddress {0x04800120}
...
set_connection_parameter_value niosv_m.platform_irq_rx/spi_g_sensor.irq irqNumber {0}

add_connection niosv_m.platform_irq_rx uart.irq
set_connection_parameter_value niosv_m.platform_irq_rx/uart.irq irqNumber {1}
